# XTM architecture and demo mode

Moved verbatim from xtm/CLAUDE.md. Read it for work in xtm/. Rules extracted
from it live in AGENTS.project.md; this file is architecture and detail.
