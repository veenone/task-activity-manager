...
var curated = []backend.Issue{
	...
	{Key: "PLAT-401", Type: backend.TypeBug, Summary: "Order total wrong when VAT changes mid-session", Status: "In Progress", Assignee: "M. Ortiz", Reporter: "S. Kim", Priority: "Highest", Labels: []string{"checkout"}, SprintID: "11", SprintName: "Sprint 11", ParentKey: "PLAT-320", StoryPoints: pts(3)},
	...
	{Key: "PLAT-347", Type: backend.TypeTask, Summary: "Write retro notes template", Status: "To Do", Assignee: "S. Kim", Reporter: "S. Kim", Priority: "Low", Labels: []string{"process"}, SprintID: "11", SprintName: "Sprint 11", ParentKey: "PLAT-305", StoryPoints: pts(1)},
