...
var curated = []backend.Issue{
	{Key: "PLAT-412", Type: backend.TypeStory, Summary: "Checkout: apply promo code at payment step", Status: "In Progress", Assignee: "R. Anand", AssigneeName: "ranand", Reporter: "PO", Priority: "High", Labels: []string{"checkout", "promo"}, SprintID: "12", SprintName: "Sprint 12", ParentKey: "PLAT-350", StoryPoints: pts(5)},
	...
	{Key: "PLAT-401", Type: backend.TypeBug, Summary: "Order total wrong when VAT changes mid-session", Status: "In Progress", Assignee: "M. Ortiz", AssigneeName: "mortiz", Reporter: "S. Kim", Priority: "Highest", Labels: []string{"checkout"}, SprintID: "11", SprintName: "Sprint 11", ParentKey: "PLAT-320", StoryPoints: pts(3)},
	{Key: "PLAT-388", Type: backend.TypeRequirement, Summary: "Promo codes must be single-use per customer", Status: "Approved", Assignee: "PO", AssigneeName: "po", Reporter: "PO", Priority: "High", Labels: []string{"promo"}, ParentKey: "PLAT-350"},
	{Key: "PLAT-350", Type: backend.TypeEpic, Summary: "Promotions and discounts", Status: "In Progress", Assignee: "PO", AssigneeName: "po", Reporter: "PO", Priority: "High", Labels: []string{"promo"}, StoryPoints: pts(21)},
	{Key: "PLAT-347", Type: backend.TypeTask, Summary: "Write retro notes template", Status: "To Do", Assignee: "Demo User", AssigneeName: "demo", Reporter: "S. Kim", Priority: "Low", Labels: []string{"process"}, SprintID: "11", SprintName: "Sprint 11", ParentKey: "PLAT-305", StoryPoints: pts(1)},
	{Key: "PLAT-331", Type: backend.TypeStory, Summary: "Guest checkout without an account", Status: "Done", Assignee: "R. Anand", AssigneeName: "ranand", Reporter: "PO", Priority: "Medium", Labels: []string{"checkout"}, SprintID: "11", SprintName: "Sprint 11", ParentKey: "PLAT-320", StoryPoints: pts(8)},
	...
	{Key: "PLAT-395", Type: backend.TypeRequirement, Summary: "Every payment request must carry an idempotency key", Status: "Approved", Assignee: "PO", AssigneeName: "po", Reporter: "M. Ortiz", Priority: "Highest", Labels: []string{"payments"}, ParentKey: "PLAT-310"},
	...
	{Key: "PLAT-385", Type: backend.TypeTask, Summary: "Add the promo code analytics event", Status: "Done", Assignee: "M. Ortiz", AssigneeName: "mortiz", Reporter: "PO", Priority: "Medium", Labels: []string{"promo", "analytics"}, SprintID: "11", SprintName: "Sprint 11", ParentKey: "PLAT-350", StoryPoints: pts(2)},
	...
	// cope with.
	{Key: "PLAT-414", Type: backend.TypeSubtask, Summary: "Add the promo code input to the payment form", Status: "In Progress", Assignee: "R. Anand", AssigneeName: "ranand", Reporter: "R. Anand", Priority: "Medium", Labels: []string{"checkout"}, SprintID: "12", SprintName: "Sprint 12", ParentKey: "PLAT-412"},
	{Key: "PLAT-415", Type: backend.TypeSubtask, Summary: "Validate the promo code against the pricing service", Status: "To Do", Assignee: "M. Ortiz", AssigneeName: "mortiz", Reporter: "R. Anand", Priority: "Medium", Labels: []string{"checkout", "promo"}, SprintID: "12", SprintName: "Sprint 12", ParentKey: "PLAT-412"},
	{Key: "PLAT-402", Type: backend.TypeSubtask, Summary: "Reproduce the VAT rounding on a staging cart", Status: "Done", Assignee: "Demo User", AssigneeName: "demo", Reporter: "M. Ortiz", Priority: "High", Labels: []string{"checkout"}, SprintID: "12", SprintName: "Sprint 12", ParentKey: "PLAT-401"},
	{Key: "PLAT-320", Type: backend.TypeEpic, Summary: "Checkout experience", Status: "In Progress", Assignee: "PO", AssigneeName: "po", Reporter: "PO", Priority: "High", Labels: []string{"checkout"}, StoryPoints: pts(34)},
	{Key: "PLAT-310", Type: backend.TypeEpic, Summary: "Payments platform hardening", Status: "To Do", Assignee: "PO", AssigneeName: "po", Reporter: "M. Ortiz", Priority: "Medium", Labels: []string{"payments", "security"}, StoryPoints: pts(13)},
	{Key: "PLAT-305", Type: backend.TypeEpic, Summary: "Team rituals and process", Status: "Done", Assignee: "S. Kim", AssigneeName: "skim", Reporter: "S. Kim", Priority: "Low", Labels: []string{"process"}, StoryPoints: pts(5)},
}
